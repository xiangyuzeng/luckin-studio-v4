...
export default function KlingTextPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold tracking-tight">{t('video.kling_title')}</h1>
        <p className="text-muted-foreground mt-1">
          {locale === 'cn'
            ? 'Kling 文生视频'
            : 'Generate videos using Kling 2.6'}
        </p>
      </div>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <PromptPolishButton prompt={prompt} onPolished={setPrompt} modelHint="kling" />
            </div>
          </div>
